...
## 三、【动作提示词库】条目（11 族 · 144 条 = 108 条规则/实测 + **27 条真实爆款反推**）
...
- ❌ **不描述人物外貌**：五官 / 妆容 / 肤色 / 发型 / 发色 / 身材 / 年龄 / 气质 / 颜值
- ❌ **不描述主体服装**：颜色 / 面料 / 材质 / 图案 / 印花 / 版型 / 廓形 / 款式 / 品牌 / logo / 尺码
- ✅ 允许：身体部位（手·指尖·肘·肩·腰·膝·脚·下颌）、视线、接触物（**含作接触点的服装部位名**：
  口袋·袖口·衣襟·下摆·纽扣·拉链·帽檐·裤脚·鞋带——它们定义动作，不是"描述服装"）、道具、环境

**理由**：人脸与服装由上身参考图（Q/R/S/T–W）＋ `prompts/03-locks.md` 锁块负责。把外貌/服装写进动作句，
会和锁块**互殴**（锁说你穿这件，句子说另一件），也是换模特/换款时动作不可复用的根因。
...
> ⚠️ **为什么必须有 ①**：条数声明散在 **9 处**（本库 §三标题 + 版本历史 · `SKILL` · 迭代日志 ·
> 生图约束篇 · 反推规格篇 · 流水线总纲 · `prompts/` 两处 · 英文映射表），手改必漏 ——
> 2026 年内已**三次**「新条目入库、声明落后」（`H17` → `S17` → `S18`+`G11`）。
...
| W10 | 横过路口走到中段 | 人物在斑马线上走到中段，身影较小，环境占主体 | 正面 | 全景空镜带人 | 无 | ✅ | 机位：正面·平视 ｜ 远近：全景空镜带人 ｜ 动作：人物在斑马线上走到中段，身影较小，环境占主体 | Crossing the road, mid-way | Walking in the middle of a zebra crossing, the figure small in frame with the environment dominating | Camera: Front view · eye level ｜ Framing: wide establishing shot ｜ Action: Walking in the middle of a zebra crossing, the figure small in frame with the environment dominating |
...
| 编号 | 动作名 | 提示词片段（可直接粘） | 建议机位 | 建议景别 | 接触 | 风险 | 动作提示词（机位·远近·动作） | Action name (EN) | Clip (EN) | Action prompt (EN) (camera · framing · action) |
|---|---|---|---|---|---|---|---|---|---|---|
| E01 | 远景空镜带人 | 人物极小地走在远处，街景为主体，环境占画面 80%+ | 正面 | 全景空镜带人 | 无 | ✅ 第 9 张备选 | 机位：正面·平视 ｜ 远近：全景空镜带人 ｜ 动作：人物极小地走在远处，街景为主体，环境占画面 80%+ | Empty room with light on the wall | An empty moment: light falling on the wall, no person in frame | Camera: Front view · eye level ｜ Framing: wide establishing shot ｜ Action: An empty moment: light falling on the wall, no person in frame |
| E02 | 地面光影与影子 | 以地面投影与人物影子为主的取景，人只露下半身 | 3-4侧 | 全景空镜带人 | 环境 | ✅ | 机位：3-4侧·平视 ｜ 远近：全景空镜带人 ｜ 动作：以地面投影与人物影子为主的取景，人只露下半身 | Ground shadow composition | Framed around the shadow and light pattern on the ground, the figure only partly in frame from the waist down | Camera: Three-quarter view · eye level ｜ Framing: wide establishing shot ｜ Action: Framed around the shadow and light pattern on the ground, the figure only partly in frame from the waist down |
| E03 | 玻璃倒影人影 | 透过橱窗玻璃的倒影取景，人物的虚影叠在店内景象上 | 3-4侧 | 全景空镜带人 | 环境 | ⚠️ 倒影易乱 | 机位：3-4侧·平视 ｜ 远近：全景空镜带人 ｜ 动作：透过橱窗玻璃的倒影取景，人物的虚影叠在店内景象上 | Reflection in shop glass | Shot through the reflection in a shop window, the figure's faint reflection layered over the interior | Camera: Three-quarter view · eye level ｜ Framing: wide establishing shot ｜ Action: Shot through the reflection in a shop window, the figure's faint reflection layered over the interior |
| E04 | 街角纵深 | 人物站在街角尽端，纵深走廊式构图 | 正面 | 全景空镜带人 | 无 | ✅ | 机位：正面·平视 ｜ 远近：全景空镜带人 ｜ 动作：人物站在街角尽端，纵深走廊式构图 | Depth down a street corner | The figure standing at the far end of a street corner, a corridor-like receding composition | Camera: Front view · eye level ｜ Framing: wide establishing shot ｜ Action: The figure standing at the far end of a street corner, a corridor-like receding composition |
...
### X · 真实爆款实拍动作（小红书来源 · 2026-09-17 三批＋分享链接 · 2026-09-21 第四批，共 36 条）
...
| X28 | 撑墙交叉脚低头前倾 | 正在双手向后撑住矮墙、双脚交叉、身体略后倚的一瞬间，下巴微收看镜头 | 正面 | 全身 | 环境接触（矮墙） | S | ⚠️ 未实测（撑墙手与交叉脚易错） | 放一天 · 5446（第四批 #1） | 机位：正面·平视 ｜ 远近：全身 ｜ 动作：双手向后撑住身后的矮墙、身体略后倚、双脚在踝部交叉，下巴微收看向镜头 | Standing with both hands propped back on a low wall | Standing with the torso facing the camera and leaning slightly back, both arms angled down and back about 30–40 degrees with hands propped on the edge of a low wall behind, legs extended with ankles lightly crossed, head tilted and chin slightly lowered toward the camera | Camera: Front view · eye level ｜ Framing: full body ｜ Action: Torso facing the camera leaning slightly back, both hands propped on the low wall behind, ankles lightly crossed with one foot slightly forward, head tilted with chin lowered, gaze at the camera |
| X29 | 街边迈步微屈膝侧倾 | 正在街边向前迈出一步、前腿微屈膝、上半身向一侧轻倾的一瞬间，看向镜头 | 3-4侧 | 全身 | 无 | W | ⚠️ 未实测（步态重心与手部位置易漂） | 陈15 · 1318（第四批 #9） | 机位：3-4侧·平视 ｜ 远近：全身 ｜ 动作：在街边向前迈出一步、前腿微微屈膝、骨盆靠近身后长椅、上半身向一侧轻倾，看向镜头 | Stepping forward on the street with a soft knee bend | Mid-step on the street with the torso facing the camera and tilted slightly to one side, pelvis close to a bench behind, one leg bearing weight and the other relaxed, head tilted toward the shoulder with the gaze at the camera | Camera: Three-quarter view · eye level ｜ Framing: full body ｜ Action: Stepping forward with the pelvis near the bench behind, upper body tilted slightly to one side, one leg bearing weight and the other relaxed, head tilted toward the shoulder, gaze at the camera |
| X30 | 抬手搭头顶提物站 | 正在单臂上举、手掌搭在头顶发上，另一手垂在身侧提物的一瞬间，视线看向镜头 | 正面 | 全身 | 自身接触（手触头顶）＋道具接触（手提物） | S | ⚠️ 未实测（举手过头易与头部错位） | FUYUE赴约本人 · 1163（第四批 #10） | 机位：正面·平视 ｜ 远近：全身 ｜ 动作：单臂上举、前臂越过头侧、手掌搭在头顶，另一手自然垂在大腿外侧提着物品，双脚一前一后错开，看向镜头 | One arm raised with the hand resting on top of the head | Standing with the torso facing the camera, one arm raised and bent so the hand rests on top of the head, the other arm hanging down with an object in hand, feet offset slightly one behind the other, head tilted with the gaze at the camera | Camera: Front view · eye level ｜ Framing: full body ｜ Action: One arm raised with the hand resting on top of the head, the other arm hanging at the side holding an object, feet slightly offset, head tilted, gaze at the camera |
| X31 | 坐地屈膝身体前倾撑地 | 正在坐到地面、一腿屈膝抬起、另一腿收在身下，一手前伸撑地、身体前倾的一瞬间 | 3-4侧 | 全身 | 环境接触（地面） | C | ⚠️⚠️ 未实测（地面低姿＋肢体堆叠，手部易崩）· ✅ 边界：仅限室内或干净地面，禁户外躺地 | 放一天 · 5446（第四批 #1） | 机位：3-4侧·俯拍 ｜ 远近：全身 ｜ 动作：坐在贴近地面的位置、一腿屈膝抬起膝盖靠近胸腹、另一腿深屈收在身下，一手向下伸到脚踝附近、躯干前倾，低头看向镜头 | Seated low with knees drawn up, one hand reaching down | Seated at ground level leaning forward, one leg bent with the knee close to the chest and the other folded under, one arm reaching down toward the ankle, head lowered and turned toward the camera | Camera: Three-quarter view · high angle ｜ Framing: full body ｜ Action: Seated at ground level leaning forward, one knee drawn toward the chest and the other leg folded underneath, one hand reaching down near the ankle, head lowered toward the camera |
| X32 | 并腿坐台阶双臂交叠膝上 | 正在坐在台阶边缘、双腿并拢、双臂交叠搭在膝上的一瞬间，头转向一侧看向画外 | 3-4侧 | 全身 | 环境接触（台阶） | T | ⚠️ 未实测（并腿与交叠双臂易粘连） | SHANS33 · 3545（第四批 #2） | 机位：3-4侧·俯拍 ｜ 远近：全身 ｜ 动作：坐在室外台阶边缘、臀部接触上一级踏面、双腿并拢膝部靠拢、两前臂在膝上交叠，头转向一侧看向画外 | Seated on a step with legs together and forearms crossed on the knees | Seated on the edge of an outdoor step with the torso facing the camera and leaning slightly forward, legs together with hips and knees bent and the lower legs resting on the step below, forearms crossed on the knees, head turned to one side looking off-camera | Camera: Three-quarter view · high angle ｜ Framing: full body ｜ Action: Seated on the edge of a step with legs together, forearms crossed on the knees, torso leaning slightly forward and turned toward the camera, head turned to one side looking off-camera |
| X33 | 侧身站立一手垂一手在身后 | 正在侧身站立、一手垂在腰前、另一手收在身后的一瞬间，头转向镜头 | 3-4侧 | 全身 | 自身接触（手在身后） | S | ⚠️ 未实测（身后手易丢失或变形） | ahspirin · 1672（第四批 #4） | 机位：3-4侧·平视 ｜ 远近：全身 ｜ 动作：侧身站立、肩线随身体侧转、一手屈肘垂在腰腹前、另一手向后收在腰胯后侧，双腿接近并拢，头转向镜头 | Standing in profile with one hand behind the back | Standing with the torso angled to one side and the shoulders slightly turned, one arm bent with the forearm resting in front of the waist, the other arm bent back with the hand tucked behind the hip, legs close together with one leg bearing weight, head turned to the camera | Camera: Three-quarter view · eye level ｜ Framing: full body ｜ Action: Torso angled to one side with shoulders slightly turned, one forearm resting in front of the waist and the other hand tucked behind the hip, legs close together, head turned toward the camera |
| X34 | 窗边坐一手搭杯一手在腿上 | 正在坐在窗边、一手搭在饮料杯口、另一手落在腿上的一瞬间，看向镜头 | 3-4侧 | 全身 | 道具接触（饮料杯）＋环境接触（长凳·桌沿） | T | ⚠️ 未实测（搭杯手与分腿姿态易错） | {{品牌}}（同名账号）· 1609（第四批 #6） | 机位：3-4侧·俯拍 ｜ 远近：全身 ｜ 动作：坐在窗边长凳上、双腿分开膝部外展、一臂伸出肘部搭在桌沿、手指松搭在杯口，另一手落在腿间，头轻侧看向镜头 | Seated by the window with one hand resting on a cup | Seated on a bench by the window with the torso facing the camera and leaning slightly to one side, legs apart with knees bent outward, one arm extended with the forearm on the table edge and the hand resting on a cup, the other hand on the bag between the legs, head tilted toward the camera | Camera: Three-quarter view · high angle ｜ Framing: full body ｜ Action: Seated on a bench by the window with legs apart and knees bent outward, one forearm resting on the table edge with the hand on a cup, the other hand on the bag between the legs, head tilted, gaze at the camera |
| X35 | 倚台侧坐一手托脸 | 正在侧坐在台盆边沿、一肘撑在大腿上、手掌托住脸颊的一瞬间，看向镜头 | 3-4侧 | 全身 | 环境接触（台盆边沿）＋自身接触（手托脸） | T | ⚠️⚠️ 未实测（手脸接触＋侧坐重心，双高危） | Ciara_ · 1545（第四批 #7） | 机位：3-4侧·俯拍 ｜ 远近：全身 ｜ 动作：侧坐在台盆边沿、腰背臀部倚住边缘、双腿并拢斜伸落地、一肘支在大腿上手掌托住脸颊，另一手握手机置于腿前，看向镜头 | Seated sideways on a ledge with a hand propping the cheek | Seated sideways on the edge of a basin counter with the hips and lower back against the rim, legs together extending down and forward with knees softly bent, one elbow resting on the thigh with the hand propping the cheek, the other hand holding a phone in front of the legs, head tilted toward the hand with the gaze at the camera | Camera: Three-quarter view · high angle ｜ Framing: full body ｜ Action: Seated sideways on the edge of a basin counter with the hips and lower back against the rim, legs together extending forward, one elbow on the thigh with the hand propping the cheek, the other hand holding a phone, gaze at the camera |
| X36 | 台阶屈膝一手持杯一手在腿边 | 正在坐在台阶上、一腿屈膝抬起、一手拿饮料、另一手放在腿边的一瞬间，看向镜头 | 3-4侧 | 全身 | 道具接触（饮料杯）＋环境接触（台阶） | T | ⚠️ 未实测（屈膝与持杯手易错位） | 涂你什么吖 · 1381（第四批 #8） | 机位：3-4侧·平视 ｜ 远近：全身 ｜ 动作：坐在台阶上、重心落在一条较直的支撑腿上、另一腿屈膝向外打开、双臂屈肘交叠于腹前、一手握着饮料，头轻侧看向镜头 | Seated on a step with one knee bent outward, holding a drink | Seated on a step with the torso facing the camera and slightly turned, weight on one straighter supporting leg while the other knee bends outward, forearms crossed in front of the waist with one hand holding a drink, head tilted toward the camera | Camera: Three-quarter view · eye level ｜ Framing: full body ｜ Action: Seated on a step with weight on one supporting leg and the other knee bent outward, forearms crossed in front of the waist with one hand holding a drink, head tilted, gaze at the camera |
...
> 取材口径：6 个话题（氛围感穿搭 / 初秋穿搭 / 极简风穿搭 / 风衣穿搭 / 通勤穿搭 / 韩系穿搭）→ 候选池 **107 条**
> → 下载 40 条（含 8 条视频笔记无封面图，记入跳过）→ 接触表粗筛 40→12 → **原图复核砍 2**（一条手中有酒杯、一条下半身被裁切）
> 封面瑕疵列记录的是**封面可用性**（不影响动作本身）；本批所有封面均通过 3:4 内嵌规格（1200×1600 / 0.750）。

| 编号 | 确认序号 | 笔记标题 | 作者 | 赞 | 档位 | 封面瑕疵（仅封面） | seed |
|---|---|---|---|---|---|---|---|
| X28 | 动作01 | 《SH City walk📰秋天出门随便穿穿》 | 区区欧阳 ohyx- | 7998 | A | 无 | （第四批 #1） |
| X29 | 动作02 | 《18图初秋穿搭合集》 | SHANS33 | 3545 | A | 无 | （第四批 #2） |
| X30 | 动作03 | 《𝗦𝗲𝗽𝘁𝗲𝗺𝗯𝗲𝗿🍂》 | COTTON Le | 3283 | A | 无 | （第四批 #3） |
| X31 | 动作04 | 《出门逛逛拍拍🧦》 | 放一天 | 5446 | A | 无 | （第四批 #4） |
| X32 | 动作05 | 《翎美最有腔调的女人Tracy，1-9集穿搭合集》 | Closet to U | 4666 | A | 无 | （第四批 #5） |
| X33 | 动作06 | 《有被好看到！AMI 26秋冬的撞色和叠穿》 | MMoEE | 3201 | A | 无 | （第四批 #6） |
| X34 | 动作07 | 《wardrobe update:争做早秋最有腔调之人》 | JuJu-K | 3075 | A | 无（作者与品牌同名账号，非本品牌） | （第四批 #7） |
| X35 | 动作08 | 《her wardrobe｜初秋低饱和穿搭》 | Ciara_ | 1545 | A | 无 | （第四批 #8） |
| X36 | 动作09 | 《又到了可以穿风衣的季节了！》 | 涂你什么吖 | 1381 | A | 无 | （第四批 #9） |

> 取材话题（本批共 6 个）：`#ootdinspo` · `#howto穿搭` · `#秋日时髦尖子生` · `#柔性穿搭` · `#智性穿搭` · `#不费力气的穿撘` + `#国庆出游穿搭`

> 反推口径：**只反推动作与拍摄**，剥离人物长相/身材与服装（与 `08 §二` 的剥离纪律一致）。
> 取材留档（桌面，可审计）：
> - 第一批 `本地工作区`（8 张）；第二批 `本地工作区`（10 张，编号 #1–#10 ↔ X09–X18）
> - `本地工作区`、`图片笔记封面第二批_待确认.xlsx` —— 封面 3:4 内嵌 + 六槽位反推 + 一句话提示词（一行一条）
> - `本地工作区`、`图片笔记封面第二批_反推记录/` —— 反推原文 / 候选池 / 复核记录 / 接触表
...
- **v1.6** 2026-09-20 ① **补录 `S17`（背对镜头静立）**——该条为平行会话入库，声明未同步 → 条数 132 → **133**
  （规则/实测 105 → **106**）；② **新增「动作提示词（机位·远近·动作）」列 ×106 条**（W–E 全部基础族逐条产出）：
  **不描述人物外貌，也不描述主体服装**（人脸的锁、服装的锁都归参考图与 `prompts/03-locks.md`，
  写进动作句只会与锁块互殴，也是换模特/换款后动作不可复用的根因）；口径与允许项见 §3.1；
  ③ 新增回写/校验工具 `scripts/fill_action_prompts.py`（`--scan` 禁用词扫描 / `--dry` 干跑 / `--write` 补空 / `--force` 重算），
  外貌与服装的禁用词表写在该脚本 `BAN` 里（改库即改口径）；X 族**不带**此列（列结构不同，单独治理）。
- **v1.7** 2026-09-20 **`X` 族 27 条补齐本列 → 全库 100%（11 族 133 条全部带三段式）**：X 族片段自带前导景别
  （「全身，正在…」「七分景，正在…」）→ 生成时**剥掉**，避免与「远近」段重复；新列在 X 表加在**表尾（来源之后）**，
  不动「归入族 / 来源」两列的相对位置（`load_actions` 按表头名取列，加列不影响解析与计数）。
  → 至此「动作提示词」列**取代** v1.6 里「X 族不带此列」的说法（v1.6 记录的是当轮状态）。
- **v1.8** 2026-09-21 **补录 `S18` / `G11` + 新增英文映射表**（均由平行会话推进）：
  ① `S18 正面七分·一手轻扶腰侧`、`G11 正面七分·微抬下巴看光` 两条实测条目入库 → 条数 133 → **135**
  （规则/实测 106 → **108**；族计 S 17→18、G 10→11），8 处「11 族 N 条」声明同轮对齐；
  ② 新增 `action-en-map（本仓库未收录）`（Y–AG 英文输出的官方词典），并登记进导出白名单
